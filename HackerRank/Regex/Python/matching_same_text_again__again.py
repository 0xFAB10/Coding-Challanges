'''
  Desafio: 'Matching Same Text Again & Again'
  link: http://hackerrank.com/challenges/matching-same-text-again-again/problem?isFullScreen=true
  Descrição: Verificar se a string tem exatamente 20 caracteres,
    onde os 10 primeiros seguem classes específicas
    (letra minúscula, \w, \s, \W, \d, \D, letra maiúscula, letra, vogal, \S)
    e os 10 restantes são respectivamente iguais aos 10 primeiros.
