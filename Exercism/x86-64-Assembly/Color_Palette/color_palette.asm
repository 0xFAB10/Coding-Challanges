; Desafio: 'Color Palette'
; Link: https://exercism.org/tracks/x86-64-assembly/exercises/color-palette
; Dificuldade: Easy
; Complexidade: O(1) apenas leitura e escrita na memória
; Descrição: implementar funções que trabalham com valores de cores e uma cor base
