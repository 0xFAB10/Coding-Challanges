; Desafio: 'Lasagna'
; link: https://exercism.org/tracks/x86-64-assembly/exercises/lasagna
; Dificuldade: Easy
; Complexidade: O(1) apenas operações de matemáticas básicas e registradores
; Descrição: Implemantar funções que calculam tempos relacionados ao preparo de uma lasanha
